...
/** @type {string} */
const CACHE_VERSION = '1725539810|80895830';
/** @type {string} */
const CACHE_PREFIX = 'Pong with GDScri-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'pong.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["pong.html","pong.js","pong.offline.html","pong.icon.png","pong.apple-touch-icon.png","pong.worker.js","pong.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["pong.wasm","pong.pck"];
